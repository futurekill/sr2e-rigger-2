...
const CYBER = [
  ...
  { name: "Cyberlimb Signal Booster", location: "cyberlimb", ess: 0, rating: 1, cost: 15000, avail: "6/72 hrs", index: 1.5, legality: "Restricted", notes: "Extends remote-control signal range; installed in a cyberlimb. The table lists its Essence as '—': no separate Essence cost — it uses the limb's capacity. Cost = Rating × 15,000¥. Rigger 2 p.96." },
  { name: "Snake-Eyes Remote Interface Link", location: "headware", ess: 1.0, cost: 150000, avail: "6/12 days", index: 2.5, legality: "Restricted", notes: "High-end remote interface link blending remote control with the user's own senses. Rigger 2 p.96." },
  { name: "Snake-Eyes FDDM Module", location: "headware", ess: 0.1, cost: 70000, avail: "10/21 days", index: 3, legality: "Restricted", notes: "Snake-Eyes add-on module for an FDDM network (Essence 0.1). Rigger 2 p.96." }
];
